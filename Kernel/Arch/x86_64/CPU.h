...
/*
 *  @brief Get the CR2 register content.
 *
 *  @return the content of the CR2 register.
 */
void *GetCR2();
...
public:
    ...
    typedef BitField<Reserved, 52>  PhysAddr;    ///< The page aligned physical address of the PML4.
};
...
void Invlpg(const Address_t virtAddr);

//! Invalidate the page in the TLB;
void Invlpg(const VirtAddr virtAddr);
